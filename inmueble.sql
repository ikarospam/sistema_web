...
--
-- Servidor: localhost
-- Tiempo de generación: 05-09-2020 a las 01:51:09
...
CREATE TABLE `clientes` (
  ...
  `rfc_cli` varchar(100) DEFAULT NULL,
  `nom_cli` varchar(200) DEFAULT NULL,
  `apellido_cli` varchar(200) DEFAULT NULL,
  `nacionalidad` varchar(200) DEFAULT NULL,
  `estado` varchar(200) DEFAULT NULL,
  `muni` varchar(200) DEFAULT NULL,
  `dire_cli` varchar(200) DEFAULT NULL,
  `tel` varchar(200) DEFAULT NULL,
  `correo_cli` varchar(200) DEFAULT NULL,
  `ocupacion_cli` varchar(200) DEFAULT NULL,
  `civil_cli` varchar(200) DEFAULT NULL,
  `nom_empcli` varchar(300) DEFAULT NULL,
  `puesto_cli` varchar(200) DEFAULT NULL,
  `giro_cli` varchar(200) DEFAULT NULL,
  `dire_empcli` varchar(200) DEFAULT NULL,
  `tel_emp` varchar(12) DEFAULT NULL,
  `dire_oficli` varchar(200) DEFAULT NULL,
  `teldto_cli` varchar(12) DEFAULT NULL
...
INSERT INTO `clientes` (`id_cliente`, `id_usuario`, `rfc_cli`, `nom_cli`, `apellido_cli`, `nacionalidad`, `estado`, `muni`, `dire_cli`, `tel`, `correo_cli`, `ocupacion_cli`, `civil_cli`, `nom_empcli`, `puesto_cli`, `giro_cli`, `dire_empcli`, `tel_emp`, `dire_oficli`, `teldto_cli`) VALUES
(1, 1, 'SUPFRAN12345', 'FRANCISCO', 'SUAREZ PELAEZ', 'TABASCO', 'Tabasco', 'Comalcalco', 'JOSE MARIA PINO SUAREZ', '9332093882', 'ikarospam@gmail.com', 'prueva', 'SOLTERO', 'SADSAD', 'SADSA', 'SADaa', 'ASSA', '1234567891', 'DDFSFDS', '1234567111'),
(2, 1, 'SUPFRAN123452', 'FRANCISCO', 'SUAREZ PELAEZ', 'TABASCO', 'Tabasco', 'Comalcalco', 'JOSE MARIA PINO SUAREZ', '9332093882', 'algo@gmail.com', 'NINGUNA', 'SOLTERO', 'SADSAD', 'SADSA', 'SAD', 'ASSA', '1234567891', 'DDFSFDS', '1234567111'),
(3, 1, 'SUPFRAN1234523', 'FRANCISCO', 'SUAREZ PELAEZ', 'TABASCO', 'Tabasco', 'Comalcalco', 'JOSE MARIA PINO SUAREZ', '9332093882', 'algo@gmail.com', 'NINGUNA', 'SOLTERO', 'SADSAD', 'SADSA', 'SAD', 'ASSA', '1234567891', 'DDFSFDS', '1234567111'),
(8, 1, 'SKDNSKANDKASMDA', 'PRUEV', '21321321', 'WEWQEWQ', 'Michoacán', 'Acuitzio', 'WWQEWQ', '1111111111', 'AW@ALGO.COM', 'sdf', 'sdfdsfsd', 'sdfsfsdd', 'sfsdf', 'sdfsdf', 'sdfsdf', '1234567899', 'sdfsdf', '3232234324');
...
INSERT INTO `estados` (`id_estado`, `id_usuario`, `nombre_estado`) VALUES
(1, 1, 'Aguascalientes'),
(2, 1, 'Baja California'),
...
INSERT INTO `municipios` (`id_municipio`, `id_estado`, `nom_municipio`) VALUES
(1, 1, 'Aguascalientes'),
(2, 1, 'Asientos'),
(3, 1, 'Calvillo'),
(4, 1, 'Cosío'),
...
(2271, 30, 'Tuxpan'),
(2272, 30, 'Tuxtilla'),
(2273, 30, 'Ursulo Galván'),
(2274, 30, 'Vega de Alatorre'),
(2275, 30, 'Veracruz'),
(2276, 30, 'Villa Aldama'),
(2277, 30, 'Xoxocotla'),
(2278, 30, 'Yanga'),
(2279, 30, 'Yecuatla'),
(2280, 30, 'Zacualpan'),
...
(2282, 30, 'Zentla'),
(2283, 30, 'Zongolica'),
(2284, 30, 'Zontecomatlán de López y Fuentes'),
(2285, 30, 'Zozocolco de Hidalgo'),
(2286, 30, 'Agua Dulce'),
(2287, 30, 'El Higo'),
(2288, 30, 'Nanchital de Lázaro Cárdenas del Río'),
(2289, 30, 'Tres Valles'),
(2290, 30, 'Carlos A. Carrillo'),
(2291, 30, 'Tatahuicapan de Juárez'),
(2292, 30, 'Uxpanapa'),
(2293, 30, 'San Rafael'),
(2294, 30, 'Santiago Sochiapan'),
(2295, 31, 'Abalá'),
(2296, 31, 'Acanceh'),
(2297, 31, 'Akil'),
(2298, 31, 'Baca'),
...
(2312, 31, 'Chapab'),
(2313, 31, 'Chemax'),
(2314, 31, 'Chicxulub Pueblo'),
(2315, 31, 'Chichimilá'),
(2316, 31, 'Chikindzonot'),
(2317, 31, 'Chocholá'),
(2318, 31, 'Chumayel'),
(2319, 31, 'Dzán'),
(2320, 31, 'Dzemul'),
(2321, 31, 'Dzidzantún'),
(2322, 31, 'Dzilam de Bravo'),
(2323, 31, 'Dzilam González'),
(2324, 31, 'Dzitás'),
(2325, 31, 'Dzoncauich'),
(2326, 31, 'Espita'),
(2327, 31, 'Halachó'),
...
(2352, 31, 'Peto'),
(2353, 31, 'Progreso'),
(2354, 31, 'Quintana Roo'),
(2355, 31, 'Río Lagartos'),
(2356, 31, 'Sacalum'),
(2357, 31, 'Samahil'),
(2358, 31, 'Sanahcat'),
(2359, 31, 'San Felipe'),
...
(2369, 31, 'Teabo'),
(2370, 31, 'Tecoh'),
(2371, 31, 'Tekal de Venegas'),
(2372, 31, 'Tekantó'),
(2373, 31, 'Tekax'),
(2374, 31, 'Tekit'),
(2375, 31, 'Tekom'),
(2376, 31, 'Telchac Pueblo'),
(2377, 31, 'Telchac Puerto'),
(2378, 31, 'Temax'),
(2379, 31, 'Temozón'),
(2380, 31, 'Tepakán'),
(2381, 31, 'Tetiz'),
...
(2402, 32, 'Apulco'),
(2403, 32, 'Atolinga'),
(2404, 32, 'Benito Juárez'),
(2405, 32, 'Calera'),
(2406, 32, 'Cañitas de Felipe Pescador'),
(2407, 32, 'Concepción del Oro'),
(2408, 32, 'Cuauhtémoc'),
(2409, 32, 'Chalchihuites'),
(2410, 32, 'Fresnillo'),
(2411, 32, 'Trinidad García de la Cadena'),
(2412, 32, 'Genaro Codina'),
(2413, 32, 'General Enrique Estrada'),
(2414, 32, 'General Francisco R. Murguía'),
(2415, 32, 'El Plateado de Joaquín Amaro'),
(2416, 32, 'General Pánfilo Natera'),
(2417, 32, 'Guadalupe'),
(2418, 32, 'Huanusco'),
(2419, 32, 'Jalpa'),
(2420, 32, 'Jerez'),
(2421, 32, 'Jiménez del Teul'),
(2422, 32, 'Juan Aldama'),
(2423, 32, 'Juchipila'),
(2424, 32, 'Loreto'),
(2425, 32, 'Luis Moya'),
(2426, 32, 'Mazapil'),
(2427, 32, 'Melchor Ocampo'),
(2428, 32, 'Mezquital del Oro'),
(2429, 32, 'Miguel Auza'),
(2430, 32, 'Momax'),
(2431, 32, 'Monte Escobedo'),
(2432, 32, 'Morelos'),
(2433, 32, 'Moyahua de Estrada'),
(2434, 32, 'Nochistlán de Mejía'),
(2435, 32, 'Noria de Ángeles'),
(2436, 32, 'Ojocaliente'),
(2437, 32, 'Pánuco'),
(2438, 32, 'Pinos'),
(2439, 32, 'Río Grande'),
...
(2445, 32, 'Tepechitlán'),
(2446, 32, 'Tepetongo'),
(2447, 32, 'Teúl de González Ortega'),
(2448, 32, 'Tlaltenango de Sánchez Román'),
(2449, 32, 'Valparaíso'),
(2450, 32, 'Vetagrande'),
(2451, 32, 'Villa de Cos'),
(2452, 32, 'Villa García'),
(2453, 32, 'Villa González Ortega'),
(2454, 32, 'Villa Hidalgo'),
(2455, 32, 'Villanueva'),
(2456, 32, 'Zacatecas'),
(2457, 32, 'Trancoso'),
(2458, 32, 'Santa María de la Paz');
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `apellidos`, `direccion`, `correo`, `tel`, `nom_user`, `contrasena`, `id_rol`) VALUES
(1, 'FRANCISCO', 'SUAREZ PELAEZ', 'SDFBSDIUBUB', 'ikarospam@gmail.com', '9332093882', 'pancho', 'c2Qhe1hy7NnEs', 2),
(10, 'ghdhfd', 'hdfh', 'dfhdf', 'ds@algo.com', '1234567891', 'pancho', 'ecPuGFeXMSXe6', 2),
(11, 'gsddsg', 'dgdsgsdg', 'jose maria pino suarez', 'dssd@algo.com', '1234567891', 'dfsdfdsf', '18kUeHWI/Mspk', 1),
(12, 'dsfdsfds', 'dsfdsf', 'dsfds', 'fdsfds@qalgo.com', '21321321', 'dsfsdf', 'c4l2at07S3atQ', 1),
(13, 'sadasd', 'asdsa', 'dsad', 'sa@algo.com', '1234567891', 'sd', 'c8j76MJsPtVTk', 2),
(14, 'sdfdsf', 'sdfsdf', 'sfds', 'ds@algo.com', '213213', '213', '37TwqBzYfcn4A', 1),
(15, 'fgdg', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '1aRgi4n1o4LZQ', 1),
(16, 'fgdgf', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(17, 'fgdgff', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(18, 'fgdgfff', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(19, 'fgdgffff', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(21, 'fgdgffffff', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(22, 'fgdgfffffff', 'dgdsg', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(23, 'fgdgfffffff', 'dgdsgf', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(24, 'fgdgfffffff', 'dgdsgff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(25, 'fgdgfffffff', 'dgdsgfff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(26, 'fgdgfffffff', 'dgdsgffff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(27, 'fgdgfffffff', 'dgdsgfffff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(28, 'fgdgfffffff', 'dgdsgffffff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(29, 'fgdgfffffff', 'dgdsgfffffff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(30, 'fgdgfffffff', 'dgdsgffffffff', 'dsgdsg', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(31, 'fgdgfffffff', 'dgdsgffffffff', 'dsgdsgf', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(32, 'fgdgfffffff', 'dgdsgffffffff', 'dsgdsgff', 'g@algo.com', '213333333', 'sf', '11L98V5hcZKls', 1),
(36, 'fgfdg', 'fdgfdg', 'fdgdf', 'df@algo.com', '1234567891', 'vbvc', 'e1cyQfLxp1Tug', 1),
(39, 'eeeee', 'eeee', 'eeeee', 'f@gmail.com', '3333333333', 'fd', '45fJCZ0DZUTWE', 1),
(40, 'ffgg', 'dsfdsf', 'dsfdsf', 'sa@algo.com', '2222222222', 'sd', '3dDRunvJWYsCE', 2),
(41, 'dfdsf2222223', 'sdfdsf', 'dsfdsf', 'fdsf@algo.com', '4444444444', 'asd', '06i6dhJ67dJsQ', 1),
(42, 'sad', 'dasd', 'asdas', 'asdas@algo.com', '1221332111', '213213', 'e1cyQfLxp1Tug', 1);
...
ALTER TABLE `clientes`
  ADD PRIMARY KEY (`id_cliente`,`id_usuario`),
  ADD KEY `clientes` (`id_usuario`);

--
-- Indices de la tabla `estados`
--
ALTER TABLE `estados`
  ADD PRIMARY KEY (`id_estado`,`id_usuario`),
  ADD KEY `estados` (`id_usuario`);
...
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `clientes` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `estados`
--
ALTER TABLE `estados`
  ADD CONSTRAINT `estados` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `municipios` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`);
COMMIT;
